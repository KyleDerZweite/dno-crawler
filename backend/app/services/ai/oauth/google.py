...
class GoogleOAuthFlow:
    ...
    def generate_authorization_url(self, state: str | None = None) -> tuple[str, str, str]:
...
class GoogleCredentialManager:
    ...
    async def get_valid_access_token(self) -> str | None:
        ...
        if "expires_at" in creds:
            ...
            expires = datetime.fromtimestamp(creds["expiry_date"] / 1000, tz=UTC)

        is_expired = expires and expires < datetime.now(UTC)
