...
class ModelsRegistry:
    ...
    async def ensure_loaded(self) -> None:
        ...
        if self._cache and self._cache_loaded_at:
            age_hours = (datetime.now(timezone.utc) - self._cache_loaded_at).total_seconds() / 3600
    ...
    async def _load_from_file(self) -> bool:
        ...
        try:
            ...
            # Check file age
            mtime = datetime.fromtimestamp(MODELS_CACHE_FILE.stat().st_mtime, tz=timezone.utc)
