...
class BDEWRecord:
    ...
    market_function: Optional[str] = None
...
class BDEWClient:
    ...
    async def fetch_company_details(self, company: BDEWCompany) -> Optional[BDEWRecord]:
        """
    ...
    def find_by_name(self, company_name: str) -> Optional[BDEWRecord]:
        """
    ...
    def find_by_zip_and_name(self, zip_code: str, company_name: str) -> Optional[BDEWRecord]:
        """
    ...
    async def find_in_list_by_name(self, company_name: str) -> Optional[BDEWCompany]:
        """
    ...
    async def get_bdew_code_for_name(self, company_name: str) -> Optional[str]:
        """
    ...
    async def get_bdew_record_for_name(self, company_name: str) -> Optional[BDEWRecord]:
        """
